...
$temp['xlabelx'] = $conf_padd+$conf_axis_dist+($a*$var['Vline_width'])-($temp['xstringlength']/2);
//$temp['xlabelx'] = (($a+1)*($var['Bar_width']+$conf_bar_gap))+$conf_axis_dist+$conf_padd-($var['Bar_width']/2)-($temp['xstringlength']/2);
$temp['xlabely'] = $conf_height-$conf_padd-$conf_axis_dist+$conf_axis_indent;
imagestring($img,$conf_font_size,$temp['xlabelx'],$temp['xlabely'],$temp['xstring'],$confc_text);
}
